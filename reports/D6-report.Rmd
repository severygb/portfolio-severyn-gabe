...
A conditional plot is appropriate for this data set because it explores the correlation between three continuous quantitative variables. Burned area (the variable of interest) is placed on the x-axis to facilitate easier comparison across the panels.
