...
**Response:** For someone not deeply familiar with the concept of MIC, words pointing out the most and least effective drugs is highly informative. Grouping bacteria by Gram staining shows the slight inverse correlation between Penicillin and the other two. Connecting the dots into lines also shows how closely Neomycin and Streptomycin perform.
...
**Response:** The most effictive data display depends on the question to be answered. Seeing general trends or comparing individual numbers will result in a drastically different graph. In this class, the graph and question need to be tightly intertwined.
